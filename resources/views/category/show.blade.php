                    ...
                    <form action="{{route('search-flow',$data->id)}}" method="POST">
                        <div class="form-group row">
                            <div class="col-md-2 col-12">
                                @csrf
                                <input id="name" type="text" class="form-control @error('search') is-invalid @enderror" name="search" placeholder="Search By Name And Price" autofocus>
                            ...
                            <div class="col-2">
                                ...
                                <a href="{{route('show-cat',$data->id)}}" class="btn btn-danger">refresh</a>
                            </div>
                        </div>
                    </form>
                    <div class="row">
